...
<div className="flex flex-wrap -mx-1 lg:w-full">
...
<div className=" my-1 px-1 w-full lg:my-4 lg:px-4 ">
    ...
    <article className="bg-mainAccent overflow-hidden rounded-lg shadow-lg">
      ...
      <p className='mb-4 text-default py-1 lg:px-10 text-lg leading-relaxed'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis eveniet, dolorum voluptas incidunt, ipsam aut perferendis nam expedita adipisci consequuntur consequatur autem, eligendi quasi nemo ducimus quod ullam blanditiis possimus.</p>
    </div>
